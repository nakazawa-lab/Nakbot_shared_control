...
def main():
    ...
    for i, csv_path in enumerate(csv_paths):
        ...
        # if pro_or_pablo[i] == "pablo":
        #         ax.plot(LOG["timestep"], LOG["ang_h_cost"]*LOG["safe"], label="heading difference cost")
        #         ax.plot(LOG["timestep"], LOG["vel_h_cost"]*LOG["safe"], label="velocity difference cost")
        # elif pro_or_pablo[i] == "pro":
        #         ax.plot(LOG["timestep"], 1.5*LOG["ang_h_cost"]*LOG["angsafe"], label="heading difference cost")
        #         ax.plot(LOG["timestep"], 0.7*LOG["vel_h_cost"]*LOG["linsafe"], label="velocity difference cost")
